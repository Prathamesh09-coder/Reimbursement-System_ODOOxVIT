...
async function generateReport() {
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const login = await axios_1.default.post(`${BASE_URL}/auth/login`, {
        ...
        const invalidLogin = await axios_1.default
    ...
    try {
        ...
        const user = await axios_1.default.get(`${BASE_URL}/users/1`);
        console.log("✅ Get User by ID");
        console.log("   - Single user retrieval working");
        console.log("   - With full role relationships");
        const newUser = await axios_1.default.post(`${BASE_URL}/users`, {
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const expenses = await axios_1.default.get(`${BASE_URL}/expenses`);
        console.log("✅ List All Expenses");
        console.log(`   - Count: ${expenses.data.data.length} expenses`);
        const expense = await axios_1.default.get(`${BASE_URL}/expenses/1`);
        console.log("✅ Get Expense by ID");
        console.log("   - Detailed expense retrieval working");
        const newExpense = await axios_1.default.post(`${BASE_URL}/expenses`, {
            amount: 2500,
            currency: "INR",
            category_id: 1,
        ...
        const submitted = await axios_1.default.post(`${BASE_URL}/expenses/${newExpense.data.data.id}/submit`);
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const approvals = await axios_1.default.get(`${BASE_URL}/approvals`);
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const usdExpense = await axios_1.default.post(`${BASE_URL}/expenses`, {
            amount: 100,
            currency: "USD",
            category_id: 1,
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const adminUsers = await axios_1.default.get(`${BASE_URL}/users`);
        console.log("✅ Admin Access to Users");
        console.log("   - Can retrieve all users");
        const adminExpenses = await axios_1.default.get(`${BASE_URL}/expenses`);
    ...
    console.log("═══════════════════════════════════════════════════════════════");
    try {
        const stats = await axios_1.default.get(`${BASE_URL}/users`); // Just to verify DB
